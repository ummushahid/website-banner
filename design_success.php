...
<div class="container">
  ...
  <div class="content">
    <h2><font face="Georgia" size="+6" color="#FFFFFF">Order Success!</font></h2>
    <h3>&nbsp;</h3>
    <h3>
      <table width="100%" border="0" align="center">
        <tr>
          <th height="10" align="center" scope="row"><span class="container"><font color="#FFFFFF" face="Montserrat">Hello, USER! Thank you for using Baner.</font></span></th>
        </tr>
        <tr>
          <th height="10" align="center" scope="row"><span class="container"><font face="Montserrat" color="#FFFFFF">Your design has been submitted and waiting for processing.</font></span></th>
        </tr>
        <tr>
    ...
    <form id="Step 3" name="Step 3" method="post" action="">
      <div align="center" class="button">
        ...
        <table width="90%" border="0">
          <tr align="right">
            <td colspan="2" align="center" scope="col">Customer Details</td>
          </tr>
          <tr align="right">
          ...
          <tr align="right">
            <td width="21%" scope="col">Contact No :</td>
            <td width="79%" align="left" scope="col">&nbsp;</td>
          </tr>
          <tr align="right">
          ...
          <tr align="right">
            <td height="81" scope="col">Address :</td>
            <td align="left" scope="col">&nbsp;</td>
          </tr>
          <tr align="right">
