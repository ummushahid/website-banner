...
<div class="container">
  ...
  <div class="content">
    <h2><font face="Georgia" size="+6" color="#FFFFFF">Order Confirmation</font></h2>
    <h3>
      <table width="100%" border="0" align="center">
        <tr>
          <td align="center" scope="row"><font face="Montserrat" color="#FFFFFF">Please check your details before submission.</font></td>
        </tr>
      </table>
    </h3>
    <form id="Step 3" name="Step 3" method="post" action="">
      <div align="center">
        <table width="90%" border="0">
          <tr align="right">
            <td height="55" colspan="2" align="center" class="content" scope="col">Banner Details</td>
          </tr>
          <tr align="right">
