  ...
  <div class="content">
    ...
    <h3>
      <table width="100%" border="0" align="center">
        ...
        <tr>
          <td height="10" align="center" scope="row"><font face="Montserrat" color="#FFFFFF">It's available in different size.</font></td>
        </tr>
      </table>
    </h3>
    <table width="70%" border="0" align="center">
      <tr>
        <th width="33%" height="94" scope="col"><p><img src="Imej/All Button/Size1.png" alt="Size_Small" width="366" height="300" class="button" /></p>
          <form action="" method="post" name="form2" class="button" id="form2">
            <input name="small" type="checkbox" id="small" />
            <label for="small">Size 1: Small</label>
          </form>
        <p>&nbsp;</p></th>
        <th width="33%" scope="col"><p><img src="Imej/All Button/Size2.png" alt="Size_Medium" width="366" height="300" class="button" /></p>
          <form action="" method="post" name="form3" class="button" id="form3">
            <input type="checkbox" name="medium" id="medium" />
            <label for="medium">Size 2: Medium</label>
          </form>
        <p>&nbsp;</p></th>
        <th width="33%" scope="col"><p><img src="Imej/All Button/Size3.png" alt="Size_Large" width="366" height="300" class="button" /></p>
          <form action="" method="post" name="form4" class="button" id="form4">
            <input type="checkbox" name="large" id="large" />
            <label for="large">Size 3: Large</label>
          </form>
        <p>&nbsp;</p></th>
      </tr>
    </table>
    <p><a href="design_step2.php"><img src="Imej/All Button/NextS2 - Copy.png" alt="Step2" width="221" height="60" class="button" /></a></p>
  </div>
